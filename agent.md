...
- The portable Studio package should have a user-facing root `HVAC Studio.exe` that starts the local server and opens an app-style desktop window; `bin/studio.exe --no-window` remains the automation/server-only entrypoint.
