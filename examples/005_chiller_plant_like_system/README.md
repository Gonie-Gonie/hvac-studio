...
go run ./tools/go/cmd/bcs-runner calibrate --project examples/005_chiller_plant_like_system/project.bcsproj --setup calibration/setups/chiller_cop_grid.json --save-parameter-set parameter_sets/calibrated_chiller_cop.json
```
