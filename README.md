...
- Golden examples that behave as regression assets, including scalar, generated-wrapper, stateful time-series, plant workflow, optimization, runtime-only, vectorized, external executable, and solver boundary component cases.
