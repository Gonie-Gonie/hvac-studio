...
import (
	...
	"github.com/goniegonie/hvac-studio/go/internal/calibration"
	"github.com/goniegonie/hvac-studio/go/internal/compiler"
	"github.com/goniegonie/hvac-studio/go/internal/migration"
	"github.com/goniegonie/hvac-studio/go/internal/modelvalidation"
	"github.com/goniegonie/hvac-studio/go/internal/optimization"
	"github.com/goniegonie/hvac-studio/go/internal/parameterset"
	"github.com/goniegonie/hvac-studio/go/internal/project"
	runtimecore "github.com/goniegonie/hvac-studio/go/internal/runtime"
	"github.com/goniegonie/hvac-studio/go/internal/schemaexport"
)
...
func migrateProject(args []string) error {
	...
	if !report.OK {
		return apperror.Errorf(apperror.CodeValidation, "project requires migration; see docs/user/export-runtime.md#artifact-compatibility")
	}
	return nil
}
