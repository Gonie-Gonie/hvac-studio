...
export const WORKSPACE_HELP = {
  ...
  canvas: "/docs/user/modeling.md#build-systems",
  code: "/docs/user/modeling.md#edit-python",
  parameters: "/docs/user/modeling.md#parameters",
  artifacts: "/docs/user/modeling.md#project-artifacts",
  run: "/docs/user/workflows.md#run-simulation",
  export: "/docs/user/export-runtime.md",
};

export const RESULT_HELP = {
  calibration: "/docs/user/workflows.md#calibration",
  dataValidation: "/docs/user/workflows.md#data-validation",
  optimization: "/docs/user/workflows.md#optimization",
  parameterManagement: "/docs/user/modeling.md#parameters",
  run: "/docs/user/workflows.md#run-simulation",
};
