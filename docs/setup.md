...
`bin/`, `dist/build/`, `dist/docs/`, `.tmp/`, and Python `__pycache__/`
directories plus package build folders while preserving release zip files
already written under `dist/`.
