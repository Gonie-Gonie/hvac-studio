...
- Add templates for controller, stateful component, data source, data sink, utility component, vectorized execution, and external executable execution.
...
| PM-103 | Component templates | Done: controller, stateful, data source, data sink, utility, vectorized, external executable, and scalar generated-wrapper templates are selectable and smoke-tested | Keep templates packaged and aligned with runtime support boundaries |
