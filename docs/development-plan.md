...
| PM-105 | Python editor | In progress: gutter problem markers, common source-check quick fixes, hover text, and generated-wrapper `step` snippets are in place; formatting, richer diagnostics, and traceback mapping still need depth | Common source problems can be diagnosed and fixed inside Studio |
